...
input = """.......262....300...................507.....961..............668.....................189.906...........................624..................
...
def build_number(number):
    ...
    for count, digit in enumerate(number[::-1]):
        result_number += digit * pow(10, count)
    return result_number

def valid_number(pos_array, symbol_pos):
    for pos in pos_array:
        for symbol in symbol_pos:
            if symbol.x - 1 <= pos.x <= symbol.x + 1 and symbol.y - 1 <= pos.y <= symbol.y + 1:
                return True
...
for line_number, line in enumerate(input.splitlines()):
    ...
    for char_pos, char in enumerate(line):
        vector = Vector2(char_pos, line_number)
        if char.isdigit():
            ...
            symbols.append(vector)

        if len(number) > 0:
            numbers.append((build_number(number), number_vectors))
            number = []
            number_vectors = []
...
for symbol in symbols:
    valid_count = 0
    gear_number = []
    for number, pos_array in numbers:
        if valid_number(pos_array, [symbol]): 
            valid_count += 1
            gear_number.append(number)
            
    if valid_count == 2:
        result += gear_number[0] * gear_number[1]
